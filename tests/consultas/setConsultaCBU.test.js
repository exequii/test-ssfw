...
test('Setear Consulta de CBU - Cta Pesos - Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "ABB  C  ",
            buffer_B: "11",
    ...
    expect(JSON.stringify(Consultas.setConsultaCBU(stateDataInicial))).toBe(JSON.stringify(stateData));
});
...
test('Setear Consulta de CBU - Cta Pesos - No Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "ABB  D  ",
            buffer_B: "11",
...
test('Setear Consulta de CBU - Cta Dolares - Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "ACA  C  ",
            buffer_B: "02",
...
test('Setear Consulta de CBU - Cta Dolares - No Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "ACA  D  ",
            buffer_B: "02",
