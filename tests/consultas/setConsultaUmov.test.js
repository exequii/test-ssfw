...
test('Setear Consulta de UMOV - Cta Pesos - Imprime Ticket', () => {
var stateData = {
    properties: {
        opcode: "BDC     ",
            buffer_B: "11",
    ...
    expect(JSON.stringify(Consultas.setConsultaUMov(stateDataInicial))).toBe(JSON.stringify(stateData));
});
...
test('Setear Consulta de UMOV - Cta Pesos - No Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "BDC     ",
            buffer_B: "11",
...
test('Setear Consulta de UMOV - Cta Dolares - Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "BDG     ",
            buffer_B: "02",
...
test('Setear Consulta de UMOV - Cta Dolares - No Imprime Ticket', () => {
    var stateData = {
        properties: {
            opcode: "BDG     ",
            buffer_B: "02",
